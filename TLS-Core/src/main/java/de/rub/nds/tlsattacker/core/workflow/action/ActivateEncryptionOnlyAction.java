...
public class ActivateEncryptionOnlyAction extends ConnectionBoundAction {

    private static final Logger LOGGER = LogManager.getLogger();

    public ActivateEncryptionOnlyAction() {
    }

    @Override
    public boolean equals(Object o) {
        return o instanceof ActivateEncryptionOnlyAction;
    }
